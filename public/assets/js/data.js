/**
 * CDMSD — Verified Organizational Data & CMS Content Models
 * Strict Fact-Checking Rules Applied:
 * - VERIFIED: Directly supported by public records / evaluation reports
 * - CLIENT_PROVIDED: Marked as placeholders until confirmed by CDMSD
 * - EDITORIAL: Framing and contextual prose
 */
...
window.CDMSD_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      thematicTags: ["CBDRM", "Livelihood Uplift", "Community Resilience", "KP / Former FATA", "Resilience Study"],
      verificationStatus: "VERIFIED",
      sourceMetadata: {
  ...
  resources: [
    {
      ...
      relatedProject: "thar-desert-emergency-response-evaluation",
      verificationStatus: "VERIFIED",
    ...
    },
    {
      ...
      relatedProject: "bajaur-mohmand-livelihood-drr",
      verificationStatus: "VERIFIED",
    ...
    },
    {
      ...
      relatedProject: "training-master-trainers-cbdrm",
      verificationStatus: "VERIFIED",
  ...
  teamPolicy: {
    notice: "CDMSD maintains an extensive multidisciplinary roster of certified technical specialists across disaster risk management, climate adaptation, WASH engineering, environmental science, and social development.",
    leadershipDisclaimer: "[Leadership information and formal directory to be published upon official verification by CDMSD.]",
    rosterCategories: [
      "Disaster Risk Reduction & Hazard Modeling Specialists",
      "Climate Change Adaptation & CVRA Assessors",
      "WASH & Public Health Engineers",
      "Food Security & Sustainable Livelihood Analysts",
      "Social Mobilization & Participatory Development Experts",
      "Monitoring, Evaluation & Research (MEL) Consultants"
    ]
  },
